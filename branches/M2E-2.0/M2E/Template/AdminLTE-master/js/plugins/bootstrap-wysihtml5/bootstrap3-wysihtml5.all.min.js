...
window.rangy = function () {
        ...
        e.prototype = {
            ...
            getAncestorWithClass: function (c) {
                for (var d; c; ) {
                    ...
                    else d = !0; if (c.nodeType == a.ELEMENT_NODE && b.dom.arrayContains(this.tagNames, c.tagName.toLowerCase()) && d) return c;
                    c = c.parentNode
                }
                return !1
            },
    ...
    function (a) {
        a.commands.insertImage = {
            exec: function (b, c, d) {
                var imgEditForRegexMath = d;
                imgEditForRegexMath = imgEditForRegexMath.replace(/\//g, '\\/');
                userSession.wysiHtml5UploadedImageUrlLink.push({ orig: d, regex: imgEditForRegexMath });
