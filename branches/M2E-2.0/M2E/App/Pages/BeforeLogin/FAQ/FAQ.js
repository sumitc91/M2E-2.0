...
define([appLocation.preLogin], function (app) {
    app.controller('beforeLoginFAQ', function ($scope, $location, $http, $rootScope, CookieUtil, $anchorScroll, $sce) {
        ...
        $scope.FAQGeneralList = [
            ...
            {
                className: "div_heading5", id: "Accepter", question: "How can I join Crowd Automation?", answer: $sce.trustAsHtml("It's pretty simple. Go to www.cautom.com, now if you are a new " + clientConstants.name +
                    ", please visit <a class='undeline_anchor' href='#/signup/client'>Crowd Automation Requester</a> section, like millions of students want to register please visit <a class='undeline_anchor' href='#/signup/user'>Crowd Automation Accepter</a> section." +
            ...
            { className: "div_heading6", id: "DeleteMyAccount", question: "Can I delete my account? ", answer: "Mostly you never will! Still if you ever want to delete an account click on the delete section in settings section. If you are unable to do this send us an email at " + companyConstants.supportEmail + "." },
            { className: "div_heading7", id: "TrackingSystem", question: "Do you have a tracking system?", answer: "We have a very sophisticated tracking system that monitors your work performance. Based on the rating our system gives you more jobs will be assigned." },
            { className: "div_heading8", id: "CustomerServiceNumber", question: "Do you have customer service number?", answer: "Sorry, we don't have a phone number for customer service. Simply because we don't want you to stay in a long queue and listen to some cranky music. Just fill the contact form with your question and send us. We will email you our response. If it's not solved in an email conversation. We will call you at our expense!" },
            { className: "div_heading9", id: "HowToContactUs", question: "How to conatct us?", answer: "Sorry, we don't have a phone number for customer service. Simply because we don't want you to stay in a long queue and listen to some cranky music. Just fill the contact form with your question and send us. We will email you our response. If it's not solved in an email conversation. We will call you at our expense!" }
        ];
