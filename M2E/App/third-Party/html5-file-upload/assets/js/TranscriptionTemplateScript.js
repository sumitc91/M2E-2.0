$(function () {
    ...
    dropbox.filedrop({
        ...
        uploadFinished: function (i, file, response) {
            ...
            userSession.imgurImageTranscriptionTemplate.push(response);
            var scope = angular.element(document.getElementById("TranscriptionTemplateViewAfterUploadId")).scope();
