...
define([appLocation.postLogin], function (app) {
    ...
    app.controller('createTemplateController', function ($scope, $http, $rootScope, $routeParams, CookieUtil) {
        ...
        $scope.ClientCreateTemplateFunction = function () {
            ...
            var clientCreateTemplateData = { Data: $rootScope.jobTemplate, ImgurList: userSession.listOfImgurImages, TemplateInfo: { type: $routeParams.type, subType: $routeParams.subType, description: $('#createTemplateDescriptionText').val(), totalThreads: $("#totalNumberOfThreads").val(), amountEachThread: $("#amountPerThreadTextBoxInput").val()} };
