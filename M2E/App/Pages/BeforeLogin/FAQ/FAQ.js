    ...
    app.controller('beforeLoginFAQ', function ($scope, $location, $http, $rootScope, CookieUtil, $anchorScroll, $sce) {
        ...
        $scope.FAQOverviewList = [
            ...
            },
            {
                ...
                id: "joinCautom", question: "How can I join " + companyConstants.name + "?",
                answer: $sce.trustAsHtml("It's pretty simple. Go to www.cautom.com, now if you are a new " + clientConstants.name +
        ...
        $scope.FAQRequesterGeneralPoliciesList = [
            {
                className: "div_heading1",
                id: "OffensiveContent", question: "Can I create a " + userConstants.task_abb + " that may contain explicit or offensive content?",
                answer: $sce.trustAsHtml("<p>If your " + userConstants.task_abb + " could contain explicit or offensive content, for instance, nudity, make sure to do the following:</p>" +
        ...
        $scope.FAQRequesterPaymentList = [
            {
                className: "div_heading1",
                id: "payToAccepter", question: "How do I pay for " + userConstants.task_abb + "s on " + companyConstants.fullName + "?",
                answer: $sce.trustAsHtml("After getting satisfied over results submitted by " + userConstants.name_abb + "s, you will pay against bill. ")
            },
            {
                className: "div_heading2",
        ...
        $scope.FAQRequesterCITRelatedtList = [
            {
                className: "div_heading1",
                id: "requesterStart", question: "How do I get started as a " + clientConstants.name_abb + "? ",
                answer: $sce.trustAsHtml("The three steps to getting started are 1) signing up on cautom, 2) design your " + userConstants.task_abb + "s, and 3) publishing a " + userConstants.task_abb + ". So, if you haven't already, sign up as a " + companyConstants.name + " -be sure to add your details and a payment method." +
