...
define([appLocation.userPostLogin], function (app) {
    app.config(function ($routeProvider) {
        ...
        //when("/showTemplateDetail/:refKey", { templateUrl: "../../App/Pages/UserAfterLogin/ShowTemplateDetail/ShowTemplateDetail.html" }).
                       ...
                       when("/userAllMessages", { templateUrl: "../../App/Pages/UserAfterLogin/ShowAllMessages/ShowAllMessages.html" }).
                       when("/userAllNotifications", { templateUrl: "../../App/Pages/UserAfterLogin/ShowAllNotifications/ShowAllNotifications.html" }).
