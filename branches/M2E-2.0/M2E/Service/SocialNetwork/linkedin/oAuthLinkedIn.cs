...
namespace M2E.Service.SocialNetwork.linkedin
{
    public class oAuthLinkedIn : oAuthBase2
    {
        ...
        public string ConsumerKey
        {
            get
            {
                ...
                {
                    _consumerKey = ConfigurationManager.AppSettings["linkedinAppID"];
        ...
        public string ConsumerSecret
        {
            get
            {
                ...
                {
                    _consumerSecret = ConfigurationManager.AppSettings["linkedinAppSecret"];
